<div class="container px-2 border text-center border-3 rounded" style="background:  #00b8ea">
  <br>
    <h1 class="display-2 text-white" style="text-shadow: black 2px 5px;"> Objets et tableaux </h1>
    <!--Waves Container-->
  ...
  <div class="row gy-5">
      <div class="col-6">
        <div class=" p-2 bg-light">  <br>
          <button class="btn btn-info col-6-4 p-1 " id="cane" onclick="seeChien()">

              <span class="spinner-border spinner-border-sm float-end  width="2em" height="2em"" role="status" aria-hidden="true"></span>
              <span class="visually-hidden">Loading...</span>
              <br>
            <img src="../ico/chien.png" alt="chien" width="45%" height="auto"></img><br>
            <h3 class="text-white"> Chien</h3>
          </button>
        </div>

        <button type="button" class="btn btn-success" onclick="addchien()"> +Ajouter</button>
      </div>
    ...
    <div class="col-6">
      <div class="p-2 bg-light">   <br>
         <button class="btn btn-info col-6-4 p-1" id="gatto" onclick="seeChat()">
            ...
            <span class="spinner-border spinner-border-sm float-end" role="status" aria-hidden="true"  width="2em" height="2em"></span>
            <span class="visually-hidden">Loading...</span>
            <br>
            <img src="../ico/chat.png" alt="gatto" width="45%" height="auto" ></img><br>
            <h3 class="text-white"> Chat </h3>
          </button>
        </div>
        <button type="button" class="btn btn-success" onclick="addchat()"> +Ajouter</button>
