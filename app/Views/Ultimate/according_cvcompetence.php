<div class="accordion-item" >
    <!--  ACCORDING HEADER COMPETENCE-->
    <h2 class="accordion-header"  id="headingThreeCvresponsive">
      <button class="accordion-button collapsed border border-5 border-white rounded " type="button" data-bs-toggle="collapse" data-bs-target="#collapseThreeCvresponsive" aria-expanded="false" aria-controls="collapseThreeCvresponsive" style="background: #cfe2ff">
        <div class="d-flex bd-highlight mb-3">
            <svg viewBox="0 0 512 512" class="iconaccording">
              <g>
            ...
            <div class="align-self-end p-2 bd-highlight"><b class="fs-1 list-inline-item">Competence</b></div>
        </div>

      </button>
    </h2>

    <!-- COLLAPSE COMPETENCE START-->
    <div id="collapseThreeCvresponsive" class="accordion-collapse collapse" aria-labelledby="headingThreeCvresponsive" data-bs-parent="#accordionFormation">
      <!--  ACCORDING BODY FORMATION-->
      <div class="accordion-body rounded text-dark" style="background: #7d85fca1;">
          ...
          <div class="tab-content justify-content-center align-middle" id="nav-tabContent">
            <div class="collapse multi-collapse" id="multiCollapseExample1">
              <?php echo view('Ultimate/table_cvprogrammation.php'); ?>
            </div>

            <!-- TABELLA GRAPHISME ++ START-->
            <div class="collapse multi-collapse" id="multiCollapseExample2">
              <?php echo view('Ultimate/table_cvgraphisme.php'); ?>
            </div>
            <!-- TABELLA GRAPHISME // END-->

            <!-- TABELLA LANGUAGE ++ START -->
            <div class="collapse multi-collapse" id="multiCollapseExample3">
              <?php echo view('Ultimate/table_cvlanguage.php'); ?>
            </div>
            <!-- TABELLA LANGUAGE // END -->
          </div>
      </div>
    </div>
</div>
