...
<?= $this->section('content') ?>
  ...
  <div class="row p-2 m-1 bg-gradient bg-primary">
          ...
          <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
              ...
              <ul class="nav nav-tabs" id="myTab" role="boot">
                ...
                <li class="nav-item active" role="boot">
                  <button class="nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">HOME NEW</button>
                </li>
    ...
    <div class="col-12 col-md-8"> <!-- COLONNA DX -->
      ...
      <p class="text-center">
        ...
        <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab"><?php echo view('Ultimate/cvresponsive2'); ?></div>
        <div class="tab-pane" id="log" role="tabpanel" aria-labelledby="log-tab">SIGN IN<?//php echo view('ex3.php'); ?></div>

        <div class="tab-pane" id="settings" role="tabpanel" aria-labelledby="settings-tab"><?php echo view('Ultimate/Costantes'); ?></div>
        <div class="tab-pane" id="variables" role="tabpanel" aria-labelledby="variables-tab"><?php echo view ('Ultimate/Variables'); ?></div>

        <div class="tab-pane" id="exercice" role="tabpanel" aria-labelledby="exercice-tab"><?php echo view('Ultimate/example_javas'); ?></div>

        <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab"><?php echo view('Ultimate/ex1_moyen'); ?></div>
        <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab"><?php echo view('Ultimate/ex2_moyen'); ?></div>
        <div class="tab-pane" id="apitest" role="tabpanel" aria-labelledby="apitest-tab">API METEO<?php echo view('Ultimate/testapi'); ?></div>
